...
if __name__ == "__main__":
    ...
    print('#user = %d, #n=%d, K=%d, decoder = %s, Memory = %d, Delta = %d, channel_n=%d'%(N,n,K,decoder_mode, Memory, Delta, channel_n))

    # Load data
    channel = np.loadtxt('../data/K{0}_D{1}/InputData_MonteCarlo{2}_K{0}_Distance{1}.txt'.format(str(N), str(Distance), str(channel_n)))
    ...
    # save data into txt
    save_to_txt(k_idx_his, "../data/K{1}_D{2}/Binary_DROO_k_MonteCarlo{0}_K{1}_Distance{2}.txt".format(str(n), str(N), str(Distance)))
    save_to_txt(rate_his, "../data/K{1}_D{2}/Binary_DROO_cost_MonteCarlo{0}_K{1}_Distance{2}.txt".format(str(n), str(N), str(Distance)))
    save_to_txt(rate_his_ratio, "../data/K{1}_D{2}/Binary_DROO_CostRatio_MonteCarlo{0}_K{1}_Distance{2}.txt".format(str(n), str(N), str(Distance)))
    save_to_txt(mem.cost_his, "../data/K{1}_D{2}/Binary_DROO_loss_MonteCarlo{0}_K{1}_Distance{2}.txt".format(str(n), str(N), str(Distance)))
